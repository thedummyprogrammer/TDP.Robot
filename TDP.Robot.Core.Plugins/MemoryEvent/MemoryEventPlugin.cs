...
namespace TDP.Robot.Plugins.Core.MemoryEvent
{
    public class MemoryEventPlugin : IPlugin
    {
        ...
        public Icon PluginIcon { get { return Resource.IcoMemoryEvent32x32; } }
        ...
        {
            WndMemoryEventConfig F = new WndMemoryEventConfig();
        ...
        {
            return new Type[] { typeof(MemoryEvent), typeof(MemoryEventConfig) };
        }
    }
}
