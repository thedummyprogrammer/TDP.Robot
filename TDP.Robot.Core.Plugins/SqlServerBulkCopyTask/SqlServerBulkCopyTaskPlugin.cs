...
namespace TDP.Robot.Plugins.Core.SqlServerBulkCopyTask
{
    public class SqlServerBulkCopyTaskPlugin : IPlugin
    {
        ...
        public Icon PluginIcon { get { return Resource.IcoSqlServerBulkCopy32x32; } }
        ...
        {
            WndSqlServerBulkCopyTaskConfig F = new WndSqlServerBulkCopyTaskConfig();
        ...
        {
            return new Type[] { typeof(SqlServerBulkCopyTask), typeof(SqlServerBulkCopyTaskConfig) };
        }
    }
}
