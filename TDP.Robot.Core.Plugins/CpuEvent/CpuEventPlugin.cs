...
namespace TDP.Robot.Plugins.Core.CpuEvent
{
    public class CpuEventPlugin : IPlugin
    {
        ...
        public Icon PluginIcon { get { return Resource.IcoCpuEvent32x32; } }
        ...
        {
            WndCpuEventConfig F = new WndCpuEventConfig();
        ...
        {
            return new Type[] { typeof(CpuEvent), typeof(CpuEventConfig) };
        }
    }
}
