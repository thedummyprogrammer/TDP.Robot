...
namespace TDP.Robot.Plugins.Core.FtpSftpTask
{
    ...
    {
        public FtpSftpCopyItem()
        {

        }

        public FtpSftpCopyItem(bool localToRemote, string localPath, string remotePath, bool overwriteFileIfExists, bool recursivelyCopyDirectories)
        {
